...
export default function AmountSelection(props) {
  ...
  return (
    <div style={props.style}>
        <div class='bet' value='0.1' style={{margin: '1em', opacity: selected=='0.1' ? '0.5' : null}} onClick={() => handleSelection('0.1')}>
          <img style={{height: '75px', width: '75px'}} src={pointone}/>
        </div>
        <div class='bet' value='0.25' style={{margin: '1em', opacity: selected=='0.25' ? '0.5' : null}} onClick={() => handleSelection('0.25')}>
          <img style={{height: '75px', width: '75px'}} src={pointtwofive}/>
        </div>
        <div class='bet' value='1' style={{margin: '1em', opacity: selected=='1' ? '0.5' : null}} onClick={() => handleSelection('1')}>
          <img style={{height: '75px', width: '75px'}} src={one}/>
        </div>
        <div class='bet' value='2.5' style={{margin: '1em', opacity: selected=='2.5' ? '0.5' : null}} onClick={() => handleSelection('2.5')}>
          <img style={{height: '75px', width: '75px'}} src={twopointfive}/>
        </div>
        <div class='bet' value='5' style={{margin: '1em', opacity: selected=='5' ? '0.5' : null}} onClick={() => handleSelection('5')}>
